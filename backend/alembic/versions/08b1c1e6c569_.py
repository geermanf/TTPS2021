...
Revision ID: 08b1c1e6c569
Revises: 
Create Date: 2021-11-12 02:48:07.627536
...
def upgrade():
    ...
    op.create_table('studypaststates',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('study_id', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_studypaststates_id'), 'studypaststates', ['id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_studypaststates_id'), table_name='studypaststates')
    op.drop_table('studypaststates')
